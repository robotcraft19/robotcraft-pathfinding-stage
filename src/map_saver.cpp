...
private:
	...
	void saveMap() {
		...
		*  occupancy grid from /map topic as image */
		...
		system("cd ~/catkin_ws/src/robotcraft-pathfinding-stage/scans && rosrun map_server map_saver -f map_backup");
	}
	...
	void saveRobotPose() {
		...
		*  for target position calculation */
		...
		file.append("/catkin_ws/src/robotcraft-pathfinding-stage/scans/rob_pos_backup.txt");
