...
private:
	...
	void saveMap() {
		...
		*  occupancy grid from /map topic as image */
		...
		system("cd ~/catkin_ws/src/amazebot-pathfinding-stage/scans && rosrun map_server map_saver -f map_backup");
	}
	...
	void saveRobotPose() {
		...
		*  for target position calculation */
		...
		file.append("/catkin_ws/src/amazebot-pathfinding-stage/scans/rob_pos_backup.txt");
        ...
        while (ros::ok())
        {
	        	...
	        	saveMap();
						...
						<< " and saving robot's pose as rob_pos_backup.txt"
					 	<< " in ~/catkin_ws/src/amazebot-pathfinding-stage/scans");
	        	}
